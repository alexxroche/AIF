...
// ********************************* DISPLAY FRAME *****************************************
function start_main_frame(){
    echo("<table><th><center>SSH Key Management SKM - v2.0</center></th></table>\n");
    echo("<table width='100%'>\n");
    echo("  <tr valign='top'>\n");
}

function start_main_frame_view($id){
    echo("<fieldset><center><bold>Current view : get_group_name($id) </bold></center></fieldset>\n");
    echo("<table width='100%'>\n");
    echo("  <tr valign='top'>\n");
}
...
function end_main_frame(){
    echo("  </tr>\n");
    echo("</table>\n");
    echo("<table><th><center>Jerome Boismartel 2010</center></th></table>\n");
}
...
function display_menu(){
    ...
    echo("        <a href='keyrings.php'>Keyrings</a><br>\n");
    ...
    echo("        <a href='accounts.php'>Accounts</a><br>\n");
    echo("      </fieldset>\n");
	...
	echo("        <a href='show_all_hosts.php'>All Hosts</a><br>\n");
		...
		echo("          <a href=\"hosts-view.php?id_hostgroup=$id_hostgroup\"><img src='images/arrowbright.gif'> $name</a><br>\n");
                }
    ...
    echo("        <a href='contract_search.php'>Maint.Contract Search</a><br>\n");
