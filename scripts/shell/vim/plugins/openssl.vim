...
autocmd BufReadPost,FileReadPost   .auth.aes highlight Folded ctermbg=black ctermfg=green
autocmd BufReadPost,FileReadPost   .auth.aes set updatetime=300000
autocmd CursorHold                 .auth.aes quit

autocmd BufReadPost,FileReadPost   .auth.aesa set foldexpr=HeadlineDelimiterExpression(v:lnum)
autocmd BufReadPost,FileReadPost   .auth.aesa set foldlevel=0
autocmd BufReadPost,FileReadPost   .auth.aesa set foldcolumn=0
autocmd BufReadPost,FileReadPost   .auth.aesa set foldmethod=expr
autocmd BufReadPost,FileReadPost   .auth.aesa set foldtext=getline(v:foldstart)
autocmd BufReadPost,FileReadPost   .auth.aesa nnoremap <silent><space> :exe 'silent! normal! za'.(foldlevel('.')?'':'l')<CR>
autocmd BufReadPost,FileReadPost   .auth.aesa nnoremap <silent>q :q<CR>
autocmd BufReadPost,FileReadPost   .auth.aesa highlight Folded ctermbg=black ctermfg=green
autocmd BufReadPost,FileReadPost   .auth.aesa set updatetime=300000
autocmd CursorHold                 .auth.aesa quit
